...
type
  ...
  /// </summary>
function ReceiveBuffer(AClient: TIdTCPClient; var ABuffer: TIdBytes)
  : Boolean; overload;

/// <summary>
/// Function for transfer of Bytes Arrays via INDY 10 TCP IP Servers
/// </summary>
function SendBuffer(AClient: TIdTCPClient; ABuffer: TIdBytes): Boolean;
  overload;
...
/// Function for transfer of STREAMS
/// </summary>
function ReceiveStream(AContext: TIdContext; AStream: TStream)
  : Boolean; overload;

/// <summary>
/// Function for transfer of STREAMS
/// </summary>
function ReceiveStream(AClient: TIdTCPClient; AStream: TStream)
  : Boolean; overload;

function ReceiveStream2(AContext: TIdContext; AStream: TStream)
  : Boolean; overload;
...
function BytesToInteger(const AValue: TIdBytes): Integer; inline;
begin
...
var
  ...
  var
    LBytes: TIdBytes;
  begin
    AContext.Connection.IOHandler.ReadBytes(LBytes, SizeOf(Integer), False);
...
function IntToBytes(AValue: Integer): TIdBytes; inline;
begin
...
begin
  try
    ...
    try
      ...
      AContext.Connection.IOHandler.WriteDirect(IntToBytes(StreamSize));
